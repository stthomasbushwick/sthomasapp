...
//   const iconParallax = useParallax({y: [-5, 5], speed: 5 });
//   const hrParallax = useParallax({y: [-5, 5], speed: 5 });
  ...
  return (
    <>
      ...
      <div id="home-icon-sec">
        <div>
            <h1 style={{fontSize: 40, fontWeight: "bold", textAlign: "center", margin: "50px 0 0 0"}}>Join Us Every Sunday</h1>
        </div>
        <div id="home-icon-div" >
        {/* <div id="home-icon-div" ref={iconParallax.ref}> */}
            <div>
            ...
            <div>
                ...
                <h1>Address</h1>
                <p><a href="https://g.co/kgs/axqRwKc" target="_blank">1405 Bushwick Ave, <br/> Brooklyn, NY 11207</a></p>
            </div>
        </div>
      </div>
      <hr className="icon-hr"></hr>
      {/* <hr className="icon-hr" ref={hrParallax.ref}></hr> */}
