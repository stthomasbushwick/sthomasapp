...
export const Navbar = ({ children, className }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("sticky inset-x-0 top-20 z-40 w-full bg-black", className)}>
...
export const NavBody = ({ children, className, visible }) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-black px-4 py-2 lg:flex bg-black",
